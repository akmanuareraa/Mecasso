...
*/
	...
	const responseFacebook = (res) => {
		...
		var FacebookInfo = {
			...
			id: res.id,
			name: res.name,
			profilePhoto: res.picture.data.url
		}
		console.log('Facebook Info', FacebookInfo)
		props.setSocialCard('Facebook', FacebookInfo);
		...
		return (
			...
			<div className="box bg-box">
					...
					<div className="box bg-box renaipanel ">
						<div className="columns is-multiline">
							...
							<div className="column is-2">
								...
								<figure className={props.FieldList.FB == 'Yes' ? "image is-social is-active" : props.FieldList.FB == 'YesAuth' ? "image is-social is-verified" : "image is-social"}>
				...
				<div className="column is-4 is-offset-4 has-text-centered">
					{
						props.FieldList.Youtube == 'YesAuth' || props.FieldList.FB == 'YesAuth'?
							<div>
