...
import BuyTokenFiatPlasmic from '../plasmicComponents/BuytokenpageFiat';
...
function BuyToken(props) {
    ...
    const handleChange = (e, field) => {
        ...
        if (field === 'tokenamount') {
            ...
            if (uiState.wdai) {
                ...
                console.log('before', calAmount)
                if (calAmount === NaN) {
                    calAmount = 0
                } else {
                    calAmount = calAmount.toFixed(18)
                }
                console.log('after', calAmount)
                setComponentState(prevState => {
                    return {
                        ...prevState,
                        amounttopay: calAmount
                    }
                })
                ...
                console.log('before', calAmount, typeof (calAmount))
                if (calAmount.toString() === 'NaN') {
                    calAmount = 0
                } else {
                    calAmount = calAmount.toFixed(18)
                }
    ...
    async function transakTransaction() {
        let transak = new transakSDK({
            ...
            themeColor: '192A46',
            exchangeScreenTitle: 'Pay via UPI or Mobikwik'
            ...
            <div className="column has-text-centered bg-img public is-hidden-mobile">
                <BuyTokenFiatPlasmic
                    ...
                    buytokendashboard={{
                        ...
                        buybutton: {
                            onClick: () => {
                                if (parseInt(componentState.tokenamount) !== 0 && componentState.tokenamount !== undefined && componentState.tokenamount !== "") {
                                    ...
                                    alert("Please enter valid token amount to buy")
                                }
                            }
                        },
