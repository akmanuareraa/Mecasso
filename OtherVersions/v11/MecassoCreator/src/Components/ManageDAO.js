...
function ManageDAO(props) {
    ...
    console.log(props.profilePhoto,"profilePhoto");
      if(props.isWeb3 && props.DAOlist && props.DAOlist.length == 0 )		
		{
	...
	return (
                ...
                <a className="button is-renai is-small  "  disabled = {props.briefProposals?false:true} 
                ...
                <div>No Communities Found. Create one by issuing a Social Token</div>
            }
                <br></br>
                <div className ="column has-text-centered">
                ...
                <a className="button is-renai"  disabled = {props.DAOlist?false:true}  onClick={() => props.setDAO(props.state.fields.daocontract)}>
                    Load DAO Contract
                </a>    
                </div>
                <br></br><br></br>
