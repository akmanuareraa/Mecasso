                                            ...
                                            <div className="box bg-box renaipanel" >
                                                ...
                                                <div>
                                                    ...
                                                    <div className="column is-6 is-offset-3 has-text-centered ">
                                                        ...
                                                        {
                                                            props.socialIDs.Youtube.categories && props.socialIDs.Youtube.categories[0] != "Not Defined" ?
...

                                    {
                                        props.socialIDs.Instagram ?
                                            <div className="box bg-box renaipanel">
                                                ...
                                                <div className="column is-centered has-background-primary">
                                                    <p className='title is-5 has-text-black has-text-centered is-spaced'>
                                                        <b>INSTAGRAM</b>
                                                    </p>
                                                </div>
                                                <div className="column has-text-centered">
                                                    ...
                                                    Username:
                                                    <br></br>
                                                    <a href={'https://instagram.com/' + props.socialIDs.Instagram.username}>
                                                        <h3 class="title is-3">
                                                            {props.socialIDs.Instagram.username}
                                                        </h3>
                                                    </a>
                                                </div>
                                                ...
                                                <div className="column has-text-centered ">
                                                    ...
                                                    <div>{props.socialIDs.Instagram.accountType}</div>
                                                </div>

                                                <div className="column has-text-centered ">
                                                    <b>Media Count :</b> <br></br>
                                                    <div>{props.socialIDs.Instagram.mediaCount}</div>
                                                </div>

                                                <div className="column has-text-centered ">
                                                    <b>Followers Count :</b> <br></br>
                                                    <div>{props.socialIDs.Instagram.followerCount}</div>
                                                </div>
                                            </div> :
                                            ...
                                            <div className="box bg-box renaipanel">
                                                ...
                                                <div className="columns is-centered is-vcentered">
                                                    ...
                                                    <div className="column is-2 has-text-centered is-offset-1">
                                                        ...
                                                        <figure className="image is-round is-128x128">
                                                            <img src={props.socialIDs.Facebook.picture} />
                                                        </figure>
                                                ...
                                                <div className="column has-text-centered ">
                                                    <b>Email ID :</b> <br></br>
                                                    <div>{props.socialIDs.Facebook.email}</div>
                                                </div>
                                            </div> :
