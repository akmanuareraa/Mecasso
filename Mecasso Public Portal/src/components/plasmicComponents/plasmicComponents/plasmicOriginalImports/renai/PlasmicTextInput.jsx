...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: QSTyVh7IuMa/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: vs5qRiFDzzh/icon
  ...
  return (
    ...
    >
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <SearchsvgIcon
                className={classNames(projectcss.all, sty.svg__yqm6H)}
                role={"img"}
              />
            ),
      ...
      <input
        ...
        placeholder={
          args.placeholder !== undefined ? args.placeholder : "Enter Email"
        }
        type={"text"}
        value={args.value}
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : true) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__lqvGc)}
                role={"img"}
              />
            ),
