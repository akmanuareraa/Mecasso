...
import sty from "./PlasmicButton.module.css"; // plasmic-import: hUmGidH7taW/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: IsBHC9HQFEd/icon
import Icon3Icon from "./icons/PlasmicIcon__Icon3"; // plasmic-import: DFb8w3GwePh/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__bhvJc)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <Icon3Icon
                className={classNames(projectcss.all, sty.svg__d7O9R)}
                role={"img"}
              />
            ),
