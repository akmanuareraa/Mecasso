  ...
  return (
    ...
    >
      ...
      {(
        ...
        <LbCategoryButton
          data-plasmic-name={"cooking"}
          data-plasmic-override={overrides.cooking}
          className={classNames("__wab_instance", sty.cooking, {
            [sty.cookingcreatormode]: hasVariant(
              variants,
              "creatormode",
              "creatormode"
            ),

            [sty.cookingloggedin]: hasVariant(variants, "loggedin", "loggedin")
          })}
        />
      ) : null}
    </p.Stack>
...
export const PlasmicCategoryscrollbar = Object.assign(
  ...
  makeNodeComponent("root"),
  {
    ...
    cooking: makeNodeComponent("cooking"),
