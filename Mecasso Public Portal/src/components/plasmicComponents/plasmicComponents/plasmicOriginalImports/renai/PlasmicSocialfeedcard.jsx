...
function PlasmicSocialfeedcard__RenderFunc(props) {
  ...
  const addCharm = (dao, tokenName, publisheddatetime, postId, type) => {
    console.log('user charm balance', props.overrides.root.props.mainState.charmBalance)
        ...
        if (response) {
          ...
          axios
            ...
            .then(function (response, error) {
              if (response) {
                console.log(response);
                console.log("Charm Added", "props", props, props.overrides.root.props.mainState);
                props.overrides.root.props.mainState.charmBalance = props.overrides.root.props.mainState.charmBalance - 1
