            ...
            {true ? (
              <div className={classNames(projectcss.all, sty.freeBox__mPOmP)}>
                ...
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__bCkPh)}
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox__aH5Vm)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__ikCl)}
                    >
                      {p.renderPlasmicSlot({
                        defaultContents: "24k",
                        value: args.subs,
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__e2JJc)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__rwqWk)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__qDrOq)}
                    >
                      {p.renderPlasmicSlot({
                ...
                <div className={classNames(projectcss.all, sty.freeBox__d2Bou)}>
                  {p.renderPlasmicSlot({
                ...
                <p.Stack
                  as={"div"}
                  hasGap={true}
                  className={classNames(projectcss.all, sty.freeBox__knIeL)}
                >
                  <div
                    className={classNames(projectcss.all, sty.freeBox__gSQv)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__xrQoy)}
                    >
                      {p.renderPlasmicSlot({
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox___6QvmY)}
                  >
                    <div
                      className={classNames(
                        projectcss.all,
                  ...
                  <div
                    className={classNames(projectcss.all, sty.freeBox__lxY7Q)}
                  >
                    <div
                      className={classNames(projectcss.all, sty.freeBox__o7YFx)}
                    >
                      {p.renderPlasmicSlot({
